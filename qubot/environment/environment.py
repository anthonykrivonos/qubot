...
class Environment(GymEnvironment):
    ...
    def step(self, action_tuple: Tuple[Optional[UIAction], Optional[UITreeNode]]):
        ...
        done = next_node is None or next_node.is_terminal() or (not next_node.get_children() and not next_node.get_parent()) or self._step_count == self._step_limit
    ...
    def render(self, mode='human', close=False):
        print("Steps:          %d" % self._step_count)
        print("Current reward: %d" % self.__reward_sum)
